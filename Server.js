...
var Felonies={Specific:null,
            Drugs: null,
            Violence: null
};
// app.get("/GetFelonies/:ID/:FelonyType", (req, res) => {
//     Felony.find({'ID': req.params.ID,'Felony Type': req.params.FelonyType}).then((result) => {
...
function CalcLastDate(felonies_arr){
  ...
  //felonies_arr.sort((a,b) => parseInt(b["Felony Date"]) - parseInt(a["Felony Date"]))[0]["Felony Date"];
...
// let felonyType="Fraud";
// let final_score=0;
// let specific_count=0;
// let general_count=0;
// let date_weight = 0;
// Felony.find({'ID': "308558378"}).then((result) => {
//   if(result.length === 0){
//     final_score=100;
//   }
//   else {
